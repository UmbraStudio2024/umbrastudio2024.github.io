...
function actualizarContenido(indice)
{
    ...
    {
        alternativasDivs[i].innerHTML = '<button type="button" class="btn-sm btn-primary text-center" onclick="responderPregunta(' + JSON.stringify(preguntas[indice].variables[i]) + ')"><h4>' + preguntas[indice].alternativas[i] + '</h4></button>';
    }
};
